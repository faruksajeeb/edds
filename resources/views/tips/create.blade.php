        ...
        <div class="col-md-8">
            <div class="card" style="background-color: #ECF4D6;">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title py-1"><i class="fa fa-plus"></i> Create tips</h3>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-body">
                    <form action="{{ route('tips.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name='tips_english' id='tips_english' class="form-control @error('tips_english') is-invalid @enderror" placeholder="Enter tips in english" value="{{ old('tips_english') }}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name='tips_bangla' id='tips_bangla' class="form-control @error('tips_bangla') is-invalid @enderror" placeholder="অনুগ্রহ করে পরামর্শ বাংলায় লিখুন" value="{{ old('tips_bangla') }}" required>

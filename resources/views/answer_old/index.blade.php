            ...
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if (request()->get('status') != 'archived')
                                <a href="{{ url('/answers?status=archived') }}">Archived Answer</a>
                            @else
                            ...
                            @if (request()->get('status') == 'archived')
                                @can('answer.restore')
                                    <div class="float-end">
                                        ...
                                        <form id="restore-all-form" action="{{ route('answers.restore-all') }}"
                    ...
                    <div class="">
                                ...
                                <div class="col-md-6 col-sm-12 px-0">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href='{{ request()->get('status') == 'archived' ? url('/answers?status=archived') : url('/answers') }}'
                        ...
                        <td class="text-nowrap">
                            @if (request()->get('status') == 'archived')
                                ...
                                @can('answer.restore')
                                    ...
                                    <form id="restore-form-{{ $val->id }}"
                                        action="{{ route('answers.restore', Crypt::encryptString($val->id)) }}"
                                ...
                                @can('answer.force_delete')
                                    ...
                                    <form id="force-delete-form-{{ $val->id }}" style="display: none"
                                        action="{{ route('answers.force-delete', Crypt::encryptString($val->id)) }}"
                                        method="POST">
                                        @method('DELETE')
                                        @csrf
                                    </form>
                            ...
                            @else
                                ...
                                @can('answer.edit')
                                    @if ($val->status == 1)
                                        <a href="{{ route('answers.edit', Crypt::encryptString($val->id)) }}"
                                ...
                                @can('answer.delete')
                                    ...
                                    <form id="delete-form-{{ $val->id }}" style="display: none"
                                        action="{{ route('answers.destroy', Crypt::encryptString($val->id)) }}"
                                        method="POST">
                                        @method('DELETE')
                                        @csrf
                                    </form>

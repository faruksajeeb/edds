    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('areas.update', $areaInfo->id) }}" method="POST"
                        class="needs-validation" novalidate>
                        @method('PUT')
                        @csrf
                        <div class="form-group mb-3">
                            <label for=""
                                class="@if ($errors->has('division')) has-error @endif fw-bold">Division
                        ...
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for=""
                                        class="@if ($errors->has('district')) has-error @endif fw-bold">District
                                        <span class="text-danger">*</span></label><br />
                                ...
                                <div class="col-md-6">
                                    <label for=""
                                        class="@if ($errors->has('thana')) has-error @endif fw-bold">Thana/
                                        Upazilla
                                        <span class="text-danger">*</span></label><br />
                        ...
                        <div class="form-group mb-3">
                            <label for=""
                                class="@if ($errors->has('value')) has-error @endif fw-bold">Area Name in English
                                <span class="text-danger">*</span></label><br />
                            <input type="text" name='value' id='value'
                                class="form-control @error('value') is-invalid @enderror"
                                placeholder="Enter area name in english" value="{{ old('value', $areaInfo->value) }}"
                                required>
                            @if ($errors->has('value'))
                                @error('value')
                                    <div class="alert alert-danger">{{ $message }}</div>
                        ...
                        <div class="form-group mb-3">
                            <label for=""
                                class="@if ($errors->has('value_bangla')) has-error @endif fw-bold">Area Name in
                            ...
                            <input type="text" name='value_bangla' id='value_bangla'
                                ...
                                value="{{ old('value_bangla', $areaInfo->value_bangla) }}" required>
                                @if ($errors->has('value'))
                                @error('value')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" pattern="[0-9.-]" name='latitude' id='latitude'
                                        ...
                                        placeholder="Enter Latitude" value="{{ old('latitude', $areaInfo->latitude) }}"
                                        required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" pattern="[0-9.-]" name='longitude' id='longitude'
                                        ...
                                        value="{{ old('longitude', $areaInfo->longitude) }}" required>
    ...
    @push('scripts')
        <script>
            $(function() {
                ...
                var selectedDivision = "{{ $areaInfo->division }}";
                if (selectedDivision) {
                    $("#drpDivision option[value=" + selectedDivision + "]").attr('selected', 'selected');
                }
                var selectedDistrict = "{{ $areaInfo->district }}";
                if (selectedDistrict) {
                ...
                var selectedThana = "{{ $areaInfo->thana }}";
                if (selectedThana) {

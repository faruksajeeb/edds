    ...
    <section>
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body py-1">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                Current Page {{ $sub_categories->currentPage() }}
                            </div>
                        </div>
                            ...
                            <tbody>
                                @forelse ($sub_categories as $key => $val)
                                    <tr>
                                        ...
                                        <td>{{ str_replace('_', ' ', $val->sub_category_name) }}</td>
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input active_inactive_btn "
                                                    status="{{ $val->status }}" {{ $val->status == -1 ? '' : '' }}
                                                    table="sub_categories" type="checkbox" id="row_{{ $val->id }}"
                            ...
                            <div class="col-md-6 text-end">
                                <div>
                                    <p class="text-sm text-gray-700 leading-5">
                                        {!! __('Showing') !!}
                                        <span class="font-medium">{{ $sub_categories->firstItem() }}</span>
                                        {!! __('to') !!}
                                        <span class="font-medium">{{ $sub_categories->lastItem() }}</span>
                                        {!! __('of') !!}
                ...
                @include('livewire.backend.sub_category.create')
                @include('livewire.backend.sub_category.edit')
            </div>
        </div>
    </section>
</div>

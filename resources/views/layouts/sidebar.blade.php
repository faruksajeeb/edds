    ...
    <div class="navigation bg-white">
        ...
        <div class="side-menu h-100 ">
            <ul class="p-0 mb-3" id="menu">
                ...
                @if (Auth::guard('web')->user()->can('question.view') || Auth::guard('web')->user()->can('answer.view'))
                    <li>
                        ...
                        <ul class="collapse nav flex-column ms-3 ps-3 {{ Route::is('survey-report')
                            ? 'show'
                            : '' }}" id="ques_ans_submenu" data-bs-parent="#menu">
                            @can('question.view')
                                <li class="{{ Route::is('question.index') ? 'active' : '' }}">
                                    <a href="{{ url('questions') }}" class="nav-link px-2"><i class="fa-solid fa-question"></i> <span class="d-sm-inline ps-1 mb-1"> Questions</span></a>
                                </li>
                            @endcan
                            @can('sub_question.view')
                            <li class="{{ Route::is('sub_question.index') ? 'active' : '' }}">
                                <a href="{{ url('sub_questions') }}" class="nav-link px-2"><i class="fa-solid fa-question"></i> <span class="d-sm-inline ps-1 mb-1"> Sub Questions</span></a>
                            </li>
                        @endcan
                            @can('answer.view')
                                <li class="{{ Route::is('answer.index') ? 'active' : '' }}">
                                    <a href="{{ url('answers') }}" class="nav-link px-2"><i class="fa-regular fa-comment"></i><span class="d-sm-inline ps-1 mb-1"> Answers</span></a>
                                </li>
                            @endcan
                            @can('sub_answer.view')
                                <li class="{{ Route::is('sub_answer.index') ? 'active' : '' }}">
                                    <a href="{{ url('sub_answers') }}" class="nav-link px-2"><i class="fa-regular fa-comment"></i><span class="d-sm-inline ps-1 mb-1"> Sub Answers</span></a>
                                </li>
                            @endcan
                        </ul>
                    </li>

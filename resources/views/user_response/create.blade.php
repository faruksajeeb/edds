                ...
                <div class="card-body">
                    <form action="{{ route('questions.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="form-group my-1">
                            <label for="" class="@if ($errors->has('value_bangla')) has-error @endif fw-bold">Type Of Respondent *</label>
                        ...
                        <div class="form-group my-1">
                            ...
                            <select name="input_method" id="input_method" class="form-select" required>
                                ...
                                <option value="textbox" {{ old('input_method')=='textbox' ? 'selected':''}}>Text Box</option>
                                <option value="selectbox" {{ old('input_method')=='selectbox' ? 'selected':''}}>Select Box</option>
                                <option value="checkbox" {{ old('input_method')=='checkbox' ? 'selected':''}}>Checkbox</option>
                            </select>

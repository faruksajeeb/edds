    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb" class="float-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('areas')); ?>">Areas</a></li>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('areas.update', $areaInfo->id)); ?>" method="POST"
                        class="needs-validation" novalidate>
                        <?php echo method_field('PUT'); ?>
                        <?php echo csrf_field(); ?>
                        <div class="form-group mb-3">
                            <label for=""
                                class="<?php if($errors->has('division')): ?> has-error <?php endif; ?> fw-bold">Division
                                <span class="text-danger">*</span></label><br />
                            <select name="division" id="drpDivision" class="form-select" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for=""
                                        class="<?php if($errors->has('district')): ?> has-error <?php endif; ?> fw-bold">District
                                        <span class="text-danger">*</span></label><br />
                                    <select name="district" id="drpDistrict" class="form-select" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for=""
                                        class="<?php if($errors->has('thana')): ?> has-error <?php endif; ?> fw-bold">Thana/
                                        Upazilla
                                        <span class="text-danger">*</span></label><br />
                                    <select name="thana" id="drpUpazilla" class="form-select " required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            <label for=""
                                class="<?php if($errors->has('value')): ?> has-error <?php endif; ?> fw-bold">Area Name in English
                                <span class="text-danger">*</span></label><br />
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter area name in english" value="<?php echo e(old('value', $areaInfo->value)); ?>"
                                required>
...
unset($__errorArgs, $__bag); ?>
                            <?php else: ?>
                                <div class="invalid-feedback">
                                    Please enter an area name in english.
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="form-group mb-3">
                            <label for=""
                                class="<?php if($errors->has('value_bangla')): ?> has-error <?php endif; ?> fw-bold">Area Name in
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter area name in bangla"
                                value="<?php echo e(old('value_bangla', $areaInfo->value_bangla)); ?>" required>
                                <?php if($errors->has('value')): ?>
                                <?php $__errorArgs = ['value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                            <?php else: ?>
                                <div class="invalid-feedback">
                                    Please enter an area name in bangla.
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="form-group mb-3">
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="Enter Latitude" value="<?php echo e(old('latitude', $areaInfo->latitude)); ?>"
                                        required>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('longitude', $areaInfo->longitude)); ?>" required>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            $(function() {
                ...
                var selectedDivision = "<?php echo e($areaInfo->division); ?>";
                if (selectedDivision) {
                    $("#drpDivision option[value=" + selectedDivision + "]").attr('selected', 'selected');
                }
                var selectedDistrict = "<?php echo e($areaInfo->district); ?>";
                if (selectedDistrict) {
                    $("#drpDistrict").children('option[data-link="' + selectedDivision + '"]').show();
                    $("#drpDistrict option[value=" + selectedDistrict + "]").attr('selected', 'selected');

                }
                var selectedThana = "<?php echo e($areaInfo->thana); ?>";
                if (selectedThana) {
                    $("#drpUpazilla").children('option[data-link="' + selectedDistrict + '"]').show();
                    $("#drpUpazilla option[value=" + selectedThana + "]").attr('selected', 'selected');
                }
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/area/edit.blade.php ENDPATH**/ ?>
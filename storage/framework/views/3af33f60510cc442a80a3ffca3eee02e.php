    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('areas.update', Crypt::encryptString($areaInfo->id))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter  value" rows="3" required><?php echo e(old('value',$areaInfo->value)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter  value in bangla" rows="3"><?php echo e(old('value_bangla',$areaInfo->value_bangla)); ?></textarea>
                        </div>
                        <div class="form-group mb-3">
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter Latitude" value="<?php echo e(old('latitude',$areaInfo->latitude)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter longitude" value="<?php echo e(old('longitude',$areaInfo->longitude)); ?>" required>

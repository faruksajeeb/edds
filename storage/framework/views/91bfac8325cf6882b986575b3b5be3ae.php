            ...
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if(request()->get('status') != 'archived'): ?>
                                <a href="<?php echo e(url('/markets?status=archived')); ?>">Archived Markets</a>
                            <?php else: ?>
                ...
                <div class="card-body">
                    <div class="">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $markets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/market/index.blade.php ENDPATH**/ ?>
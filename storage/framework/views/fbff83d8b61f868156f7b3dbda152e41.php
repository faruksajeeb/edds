...
<head>
    ...
    <title><?php echo e($company_settings->company_name); ?> | Login</title>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control " name="email" value="<?php echo e(old('email','admin@admin.com')); ?>" required
                            autofocus />
...
<?php /**PATH D:\laragon\www\laravel\edds\resources\views/auth/login.blade.php ENDPATH**/ ?>
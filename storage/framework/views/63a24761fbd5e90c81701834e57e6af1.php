            ...
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if(request()->get('status') != 'archived'): ?>
                                <a href="<?php echo e(url('/roles?status=archived')); ?>">Deleted roles</a>
                            <?php else: ?>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td width="15%">
                                            <?php if($val->permissions->count() > 0): ?>
                                                <dl class="row mb-0 sub_question "
                                                    ...
                                                    id="permission<?php echo e($key); ?>">
                                                    <?php $__currentLoopData = $val->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <dd class="col-sm-12 badge bg-info text-dark text-start p-2">
                                                            <?php echo e($index + 1); ?>. <?php echo e(optional($permission)->name); ?>

                                                        </dd>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </dl>
                                                <?php if($val->permissions->count() > 1): ?>
                                                    <button onclick="seeMore(<?php echo e($key); ?>)"
                                                        class="btn btn-sm btn-link"
                                                        id="expandbtn<?php echo e($key); ?>">see
                                                        more &#187;</button>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        ...
                                        <td class="text-center"><?php echo e($val->guard_name); ?></td>
                        ...
                        <td class="text-nowrap">
                            ...
                            <?php else: ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role.delete')): ?>
                                    <?php if(!in_array($val->name, ['superadmin', 'developer'])): ?>
                                        <a href=""

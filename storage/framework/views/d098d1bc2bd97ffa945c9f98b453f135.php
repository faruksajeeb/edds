...
<table class="table table-bordered" width="100%">
    <thead>
        <?php if($report_format == 'export'): ?>
            <tr style="">
                <td style="height:70px;text-align:center; padding-top:10px" colspan="<?php echo e($colspan); ?>">

                </td>
            </tr>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" style="text-align:center;padding:10px; font-weight:bold;background-color:#F5DEB3;color:#000000">
                    <h1>Survey Report</h1>
                </td>
            </tr>
        <?php endif; ?>
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr style="">
                <td colspan="<?php echo e($colspan); ?>" style="padding:15px;background-color: #F5DEB3;"><b># Category:
            ...
            <?php $__currentLoopData = $category['category_records']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="">
                    <td colspan="<?php echo e($colspan); ?>" style="padding:15px;background-color: #F5DEB3;"><b>## Question:
                ...
                <?php $__currentLoopData = $question['sub_records']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $sub_question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr style="">
                        <td colspan="<?php echo e($colspan); ?>" style="padding:15px;background-color: #F5DEB3;"><b>### Sub Question:
                    ...
                    <tr style="font-weight:bold">
                        <td colspan="6" style="font-weight:bold">Total (<?php echo e($sub_question['sub_question']); ?> )</td>
                        <td style="text-align:center;font-weight:bold"><?php echo e($subQuestionTotal); ?></td>
                    </tr>
                    <tr>

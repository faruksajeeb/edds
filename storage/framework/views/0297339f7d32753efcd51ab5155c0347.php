    ...
    <div class="content container-fluid">
        <div class="row">
            <div class="col-md-4 offset-md-4">
                ...
                <form action="<?php echo e(route('change-password')); ?>" method="POST" class="needs-validation" novalidate>
...
unset($__errorArgs, $__bag); ?>"
                            name="old_password" value="<?php echo e(old('old_password')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/users/change-password.blade.php ENDPATH**/ ?>
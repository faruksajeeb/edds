                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <select name="" id="drpDistrict" class="form-select">
                                    ...
                                    <option data-link="Rajshahi" value="Chapainawabganj">Chapainawabganj</option>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <select name="" id="drpUpazilla" class="form-select">
                                    ...
                                    <option data-link="Faridpur" value="Faridpur Sadar">Faridpur Sadar</option>
                                    ...
                                    <option data-link="Gopalganj" value="Gopalganj Sadar">Gopalganj Sadar</option>
                                    ...
                                    <option data-link="Kishoreganj" value="Kishoreganj Sadar">Kishoreganj Sadar
                                    </option>
                                    ...
                                    <option data-link="Madaripur" value="Madaripur Sadar">Madaripur Sadar</option>
                                    ...
                                    <option data-link="Manikganj" value="Manikganj Sadar">Manikganj Sadar</option>
                                    ...
                                    <option data-link="Munshiganj" value="Munshiganj Sadar">Munshiganj Sadar</option>
                                    ...
                                    <option data-link="Narayanganj" value="Narayanganj Sadar">Narayanganj Sadar
                                    </option>
                                    ...
                                    <option data-link="Narsingdi" value="Narsingdi Sadar">Narsingdi Sadar</option>
                                    ...
                                    <option data-link="Shariatpur" value="Shariatpur Sadar">Shariatpur Sadar</option>
                                    ...
                                    <option data-link="Bandarban" value="Bandarban Sadar">Bandarban Sadar</option>
                                    ...
                                    <option data-link="Bandarban" value="Naikhongchhari">Naikhongchhari</option>
                                    ...
                                    <option data-link="Brahmanbaria" value="Bancharampur">Bancharampur</option>
                                    ...
                                    <option data-link="Chandpur" value="Chandpur Sadar">Chandpur Sadar</option>
                                    ...
                                    <option data-link="Chandpur" value="Matlab Dakkhin">Matlab Dakkhin</option>
                                    ...
                                    <option data-link="Cumilla" value="Cumilla Sadar South">Cumilla Sadar South
                                    </option>
                                    <option data-link="Cumilla" value="Cumilla Adarsa Sadar">Cumilla Adarsa Sadar
                                    </option>
                                    ...
                                    <option data-link="Coxsbazar" value="Coxsbazar Sadar">Coxsbazar Sadar</option>
                                    ...
                                    <option data-link="Khagrachari" value="Khagrachhari Sadar">Khagrachhari Sadar
                                    </option>
                                    ...
                                    <option data-link="Khagrachari" value="Lakshmichhari">Lakshmichhari</option>
                                    ...
                                    <option data-link="Lakshmipur" value="Lakshmipur (Laxmipur) Sadar">Lakshmipur
                                    ...
                                    <option data-link="Noakhali" value="Noakhali Sadar">Noakhali Sadar</option>
                                    ...
                                    <option data-link="Rangamati" value="Rangamati Sadar">Rangamati Sadar</option>
                                    ...
                                    <option data-link="Barishal" value="Barishal Sadar">Barishal Sadar</option>
                                    ...
                                    <option data-link="Jhalakathi" value="Jhalakathi Sadar">Jhalakathi Sadar</option>
                                    ...
                                    <option data-link="Patuakhali" value="Patuakhali Sadar">Patuakhali Sadar</option>
                                    ...
                                    <option data-link="Pirojpur" value="Pirojpur Sadar">Pirojpur Sadar</option>
                                    ...
                                    <option data-link="Bagerhat" value="Bagerhat Sadar">Bagerhat Sadar</option>
                                    ...
                                    <option data-link="Chuadanga" value="Chuadanga Sadar">Chuadanga Sadar</option>
                                    ...
                                    <option data-link="Jhenaidah" value="Jhenaidah Sadar">Jhenaidah Sadar</option>
                                    ...
                                    <option data-link="Meherpur" value="Meherpur Sadar">Meherpur Sadar</option>
                                    ...
                                    <option data-link="Satkhira" value="Satkhira Sadar">Satkhira Sadar</option>
                                    ...
                                    <option data-link="Mymensingh" value="Mymensingh Sadar">Mymensingh Sadar</option>
                                    ...
                                    <option data-link="Jamalpur" value="Jamalpur Sadar">Jamalpur Sadar</option>
                                    ...
                                    <option data-link="Netrokona" value="Netrokona Sadar">Netrokona Sadar</option>
                                    ...
                                    <option data-link="Joypurhat" value="Joypurhat Sadar">Joypurhat Sadar</option>
                                    ...
                                    <option data-link="Sirajganj" value="Sirajganj Sadar">Sirajganj Sadar</option>
                                    ...
                                    <option data-link="Nilphamari" value="Nilphamari Sadar">Nilphamari Sadar</option>
                                    ...
                                    <option data-link="Dinajpur" value="Dinajpur Sadar">Dinajpur Sadar</option>
                                    ...
                                    <option data-link="Gaibandha" value="Gaibandha Sadar">Gaibandha Sadar</option>
                                    ...
                                    <option data-link="Kurigram" value="Kurigram Sadar">Kurigram Sadar</option>
                                    ...
                                    <option data-link="Lalmonirhat" value="Lalmonirhat Sadar">Lalmonirhat Sadar
                                    </option>
                                    ...
                                    <option data-link="Sylhet" value="Dakshin Shurma">Dakshin Shurma</option>
                                    <option data-link="Sylhet" value="Zakiganj">Zakiganj</option>
                                    <option data-link="Sylhet" value="Osmani Nagar">Osmani Nagar</option>
                                    <option data-link="Habiganj" value="Habiganj Sadar">Habiganj Sadar</option>
                                    ...
                                    <option data-link="Moulvibazar" value="Moulvibazar Sadar">Moulvibazar Sadar
                                    </option>
                                    ...
                                    <option data-link="Sunamganj" value="Sunamganj Sadar">Sunamganj Sadar</option>
                                    <option data-link="Sunamganj" value="Sunamganj South">Sunamganj South</option>
                                    <option data-link="Sunamganj" value="Chhatak">Chhatak</option>
                                    <option data-link="Sunamganj" value="Jagannathpur">Jagannathpur</option>
                                    <option data-link="Sunamganj" value="Bishwamvarpur">Bishwamvarpur</option>

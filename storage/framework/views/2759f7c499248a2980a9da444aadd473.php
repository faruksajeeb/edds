                ...
                <div class="card-body">
                    <form action="<?php echo e(route('questions.update', Crypt::encryptString($questionInfo->id))); ?>"
                        ...
                        <div class="form-group my-1">
                            <label for="" class="<?php if($errors->has('value_bangla')): ?> has-error <?php endif; ?> fw-bold">Type Of Category *</label>
                            <select name="category_id" id="category_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                    
                                    <option value="<?php echo e($val->id); ?>" <?php echo e(($val->id==old('category_id',$questionInfo->category_id)) ?'selected':''); ?>><?php echo e($val->option_value); ?></option>

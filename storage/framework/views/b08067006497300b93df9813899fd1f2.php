    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('sub_answers.update', Crypt::encryptString($sub_answerInfo->id))); ?>"
                        method="POST" class="needs-validation" novalidate>
                        <?php echo method_field('PUT'); ?>
                        <?php echo csrf_field(); ?>
                        <div class="form-group my-1">
                            <label for="" class="<?php if($errors->has('value_bangla')): ?> has-error <?php endif; ?> fw-bold">Answer</label>
                            <select name="answer_id" id="answer_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                    
                                    <option value="<?php echo e($val->id); ?>" <?php echo e(($val->id==old('answer_id',$sub_answerInfo->answer_id)) ?'selected':''); ?>><?php echo e($val->value); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter question value" rows="3" required><?php echo e(old('value',$sub_answerInfo->value)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter question value in bangla" rows="3"><?php echo e(old('value_bangla',$sub_answerInfo->value_bangla)); ?></textarea>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/sub_answer/edit.blade.php ENDPATH**/ ?>
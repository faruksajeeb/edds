                ...
                <div class="card-body">
                    <form action="<?php echo e(route('questions.store')); ?>" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="form-group my-1">
                            <label for=""
                                class="<?php if($errors->has('value_bangla')): ?> has-error <?php endif; ?> fw-bold">Category <span class='text-danger'>*<span></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group my-1">
                            <label for=""
                                class="<?php if($errors->has('value_bangla')): ?> has-error <?php endif; ?> fw-bold">Respondent <span class='text-danger'>*<span></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group my-1">
                            ...
                            <select name="is_required" id="is_required" class="form-select" required>
                                ...
                                <option value="yes" <?php echo e(old('is_required') == 'yes' ? 'selected' : ''); ?>>Yes
                                </option>
                                <option value="no" <?php echo e(old('is_required') == 'no' ? 'selected' : ''); ?>>
                                    No</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group my-1">
                            <label for=""
                                class="<?php if($errors->has('image_require')): ?> has-error <?php endif; ?> fw-bold">Image Required? <span class='text-danger'>*<span></label>
                            <select name="image_require" id="image_require" class="form-select" required>
                                <option value="">--select one--</option>
                                <option value="yes" <?php echo e(old('image_require') == 'yes' ? 'selected' : ''); ?>>Yes
                                </option>
                                <option value="no" <?php echo e(old('image_require') == 'no' ? 'selected' : ''); ?>>
                                    No</option>
                            </select>

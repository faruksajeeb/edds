    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('markets.store')); ?>" method="POST" class="needs-validation"
                        novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="form-group my-1">
                            ...
                            <select name="area_id" id="area_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val->id); ?>" <?php echo e($val->id==old('area_id')?'selected':''); ?>><?php echo e($val->value); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter  value" rows="3" required><?php echo e(old('value')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter  value in bangla" rows="3"><?php echo e(old('value_bangla')); ?></textarea>
                        </div>
                        <div class="form-group mb-3">

                ...
                <div class="card-body">
                    <form action="<?php echo e(route('areas.store')); ?>" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="<?php echo e(old('value')); ?>" name='value' id='value'
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter  value"
                                required>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter value in bangla" value="<?php echo e(old('value_bangla')); ?>">
                        </div>
                        <div class="form-group mb-3">

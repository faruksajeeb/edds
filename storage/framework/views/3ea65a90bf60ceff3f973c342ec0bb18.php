    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('areas.store')); ?>" method="POST" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            <label for=""
                                class="<?php if($errors->has('value')): ?> has-error <?php endif; ?> fw-bold">Area Name in
                                English
                                <span class="text-danger">*</span></label><br />
                            <input type="text" value="<?php echo e(old('value')); ?>" name='value'
                                id='value'
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter area name in english" required>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter area name in bangla" value="<?php echo e(old('value_bangla')); ?>"
                                required>
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="Enter Latitude" value="<?php echo e(old('latitude')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="Enter Longitude" value="<?php echo e(old('longitude')); ?>" required>
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/area/create.blade.php ENDPATH**/ ?>
            ...
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if(request()->get('status') != 'archived'): ?>
                            <!-- <a href="<?php echo e(url('/sms_responses?status=archived')); ?>">Deleted SMS Responses</a> -->
                            <?php else: ?>
                            <a href="<?php echo e(url('/sms_responses')); ?>">SMS Responses</a>
                            <?php endif; ?>
                            <?php if(request()->get('status') == 'archived' && $sms_responses->total() > 0): ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.restore')): ?>
                            <div class="float-end">
                                ...
                                <form id="restore-all-form" action="<?php echo e(route('sms_responses.restore-all')); ?>" style="display:inline" method="POST">
                    ...
                    <div class="">
                        <form action="" method="GET">
                                ...
                                <div id="address-map-container" style="width:100%;height:400px;display:none ">
                                    <div style="width: 100%; height: 100%" id="address-map"></div>
                                        ...
                                        <select class="form-control" style="height:30px; padding:1px" name="search_respondent_type" id="search_respondent_type">
                                            ...
                                            <option value="<?php echo e($respondent_type->id); ?>" <?php echo e(request()->get('search_respondent_type')==$respondent_type->id?'selected':''); ?>><?php echo e($respondent_type->label); ?></option>
                                        ...
                                        <select class="form-select select2 " class="js-example-basic-single" name="search_market" id="search_market">
                                            ...
                                            <option value="<?php echo e($market->id); ?>" <?php echo e(request()->get('search_market')==$market->id?'selected':''); ?>><?php echo e($market->value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>

                                        <input type="text" class="form-control datepicker" style="height:30px; padding:1px" name="date_from" placeholder="Date From" value="<?php echo e(request()->get('date_from')); ?>" aria-label="DateFrom">
                                        <span class="input-group-text" style="height:30px; padding:1px">to</span>
                                        <input type="text" class="form-control datepicker" style="height:30px; padding:1px" name="date_to" placeholder="Date To" value="<?php echo e(request()->get('date_to')); ?>" aria-label="DateTo">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <a href='<?php echo e(request()->get('status') == 'archived' ? url('/manage_sms_responses?status=archived') : url('/manage_sms_responses')); ?>' class="btn btn-xs btn-primary me-1 refresh_btn"><i class="fa fa-refresh"></i> Refresh</a>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.export')): ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0 table-sm">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $sms_responses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-nowrap"><?php echo e($index + $sms_responses->firstItem()); ?></td>
                                        <td class="text-nowrap"><?php echo e($val->contact_no); ?></td>
                                        <td class="text-nowrap">
                                            <?php echo e(optional($val->respondent)->label); ?>

                                        </td>
                                        <td class="text-nowrap">
                                            <?php echo e(optional($val->market)->value); ?>

                                        </td>
                                        <td class="text-nowrap">
                                            <?php echo e(optional($val->category)->option_value); ?>

                                        </td>
                                        <td class="text-nowrap"><?php echo e($val->quantity); ?></td>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="btn-group">
                                                <?php if(request()->get('status') == 'archived'): ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.restore')): ?>
                                                        ...
                                                        <form id="restore-form-<?php echo e($val->id); ?>"
                                                            action="<?php echo e(route('sms_responses.restore', Crypt::encryptString($val->id))); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.force_delete')): ?>
                                                        <a href=""
                                                        ...
                                                        <form id="force-delete-form-<?php echo e($val->id); ?>"
                                                            style="display: none"
                                                            action="<?php echo e(route('sms_responses.force-delete', Crypt::encryptString($val->id))); ?>"
                                                            method="POST">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.edit')): ?>
                                                        <?php if($val->status == 1): ?>
                                                            
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.verify')): ?>
                                                        <?php if($val->status == 1): ?>
                                                            <a href=""
                                                            ...
                                                            <form id="verify-form-<?php echo e($val->id); ?>"
                                                                style="display: none"
                                                                action="<?php echo e(route('sms_responses.verify', Crypt::encryptString($val->id))); ?>"
                                                                method="POST">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sms_response.delete')): ?>
                                                        <?php if($val->status == 1): ?>
                                                            <a href=""
                                                            ...
                                                            <form id="delete-form-<?php echo e($val->id); ?>"
                                                                style="display: none"
                                                                action="<?php echo e(route('sms_responses.destroy', Crypt::encryptString($val->id))); ?>"
                                                                method="POST">
                                                                <?php echo method_field('DELETE'); ?>
                                                                <?php echo csrf_field(); ?>
                                                            </form>
                        ...
                        <?php echo e($sms_responses->withQueryString()->links()); ?>
    ...
    <script>
        ...
        const getMarket = (val) => {
            if (val) {
                ...
                fetch("<?php echo e(url('api/fetch-markets')); ?>/" + val)
...
<?php endif; ?><?php /**PATH D:\laragon\www\laravel\edds\resources\views/sms_response/index.blade.php ENDPATH**/ ?>
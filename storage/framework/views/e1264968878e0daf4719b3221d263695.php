    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb" class="float-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('permissions')); ?>">Permissions</a></li>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('permissions.store')); ?>" method="POST" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $permission_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val->name); ?>" <?php echo e((old('group_name')==$val->name) ? 'selected':''); ?>><?php echo e($val->name); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                                <option value="no" <?php echo e(old('is_menu') == 'no' ? 'selected' : ''); ?>>No</option>
                                <option value="yes" <?php echo e(old('is_menu') == 'yes' ? 'selected' : ''); ?>>Yes</option>
                            </select>
                        </div>
                        <section id="menu_section" style="display: none">
                            <div class="form-group">
                                <label for=""
                                    ...
                                    Name</label><br />
                                <input type="text" name='menu_name' id='menu_name' value="<?php echo e(old('menu_name')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/permission/create.blade.php ENDPATH**/ ?>
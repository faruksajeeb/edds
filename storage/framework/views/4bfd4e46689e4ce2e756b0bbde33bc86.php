                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb" class="float-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('sub_questions')); ?>">Sub Questions</a>
                                    </li>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('sub_questions.update', Crypt::encryptString($sub_questionInfo->id))); ?>"
                        ...
                        <div class="form-group my-1">
                            <label for=""
                                class="<?php if($errors->has('value_bangla')): ?> has-error <?php endif; ?> fw-bold">Question</label>
                            <select name="question_id" id="question_id" class="form-select" required>
                                ...
                                <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($val->id); ?>"
                                        <?php echo e($val->id == old('question_id', $sub_questionInfo->question_id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                placeholder="Enter question value in bangla" rows="3" required><?php echo e(old('value_bangla', $sub_questionInfo->value_bangla)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group my-1">
                            ...
                            <select name="input_type" id="input_type" class="form-select" required>
                                ...
                                <option value="alphabetic" <?php echo e(old('input_type',$sub_questionInfo->input_type) == 'alphabetic' ? 'selected' : ''); ?>>Alphabetic
                                </option>
                                <option value="alphanumeric" <?php echo e(old('input_type',$sub_questionInfo->input_type) == 'alphanumeric' ? 'selected' : ''); ?>>
                                    Alphanumeric</option>
                                <option value="numeric" <?php echo e(old('input_type',$sub_questionInfo->input_type) == 'numeric' ? 'selected' : ''); ?>>
                                    Numeric
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group my-1">
                            ...
                            <select name="is_required" id="is_required" class="form-select" required>
                                ...
                                <option value="yes" <?php echo e(old('is_required',$sub_questionInfo->is_required) == 'yes' ? 'selected' : ''); ?>>Yes
                                </option>
                                <option value="no" <?php echo e(old('is_required',$sub_questionInfo->is_required) == 'no' ? 'selected' : ''); ?>>
                                    No</option>
                            </select>

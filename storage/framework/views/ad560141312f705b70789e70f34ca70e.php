            ...
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if(request()->get('status') != 'archived'): ?>
                                <a href="<?php echo e(url('/sub_answers?status=archived')); ?>">Archived Sub Answer</a>
                            <?php else: ?>
                                <a href="<?php echo e(url('/sub_answers')); ?>">Sub Answer</a>
                            <?php endif; ?>
                            <?php if((request()->get('status') == 'archived') && ($sub_answers->total() >0)): ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.restore')): ?>
                                    <div class="float-end">
                                        ...
                                        <form id="restore-all-form" action="<?php echo e(route('sub_answers.restore-all')); ?>"
                    ...
                    <div class="">
                        <form action="" method="GET">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 px-0">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href='<?php echo e(request()->get('status') == 'archived' ? url('/sub_answers?status=archived') : url('/sub_answers')); ?>'
                                                class="btn btn-xs btn-primary me-1"><i class="fa fa-refresh"></i></a>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.export')): ?>
                                ...
                                <div class="col-md-3 col-sm-12">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.create')): ?>
                                        <a href="<?php echo e(route('sub_answers.create')); ?>"
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $sub_answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($index + $sub_answers->firstItem()); ?></td>
                                        ...
                                        <td>
                                            <div class="form-check form-switch">
                                                ...
                                                <?php else: ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.edit')): ?>
                                                        <input class="form-check-input active_inactive_btn "
                                                            status="<?php echo e($val->status); ?>"
                                                            <?php echo e($val->status == -1 ? '' : ''); ?> table="sub_answers"
                        ...
                        <td class="text-nowrap">
                            <?php if(request()->get('status') == 'archived'): ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.restore')): ?>
                                    ...
                                    <form id="restore-form-<?php echo e($val->id); ?>"
                                        action="<?php echo e(route('sub_answers.restore', Crypt::encryptString($val->id))); ?>"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.force_delete')): ?>
                                    ...
                                    <form id="force-delete-form-<?php echo e($val->id); ?>" style="display: none"
                                        action="<?php echo e(route('sub_answers.force-delete', Crypt::encryptString($val->id))); ?>"
                                        method="POST">
                            ...
                            <?php else: ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.edit')): ?>
                                    <?php if($val->status == 1): ?>
                                        <a href="<?php echo e(route('sub_answers.edit', Crypt::encryptString($val->id))); ?>"
                                            class="btn btn-outline-warning btn-sm"><i class="fa-solid fa-pencil"></i> Edit</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                                
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub_answer.delete')): ?>
                                    ...
                                    <form id="delete-form-<?php echo e($val->id); ?>" style="display: none"
                                        action="<?php echo e(route('sub_answers.destroy', Crypt::encryptString($val->id))); ?>"
                                        method="POST">
                                        <?php echo method_field('DELETE'); ?>
                                        <?php echo csrf_field(); ?>
                                    </form>
                        ...
                        <?php echo e($sub_answers->withQueryString()->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp8.1.6\htdocs\laravel\edds\resources\views/sub_answer/index.blade.php ENDPATH**/ ?>
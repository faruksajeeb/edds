...
<head>
    <meta charset="utf-8">
    <title><?php echo e($theme_settings->website_name); ?></title>
    ...
    <style>
        ...
        @font-face {
            ...
            src: url(<?php echo e(asset('fonts/MaterialIcons-Regular.ttf')); ?>);
        }
        @font-face {
            font-family: solaimanLipiBanglaFont;
            src: url(<?php echo e(asset('frontend-assets/fonts/SolaimanLipi/SolaimanLipi.ttf')); ?>);
        }
        *{
            /* font-family: myDefaultFont; */

    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card" style="background-color: #ECF4D6;">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="breadcrumb" class="float-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('app_footer_logos')); ?>">app footer logos</a></li>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('app_footer_logos.store')); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
...
<?php endif; ?><?php /**PATH D:\laragon\www\laravel\edds\resources\views/app_footer_logo/create.blade.php ENDPATH**/ ?>
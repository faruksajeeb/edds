            ...
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if(request()->get('status') != 'archived'): ?>
                                <a href="<?php echo e(url('/areas?status=archived')); ?>">Deleted Areas</a>
                            <?php else: ?>
                ...
                <div class="card-body">
                    <div class="">
                        <form action="" method="GET">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 col-sm-12 input-group">
                                    <select name="search_status" class="form-select mx-1" id="search_status">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                                ...
                                                <?php else: ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('area.edit')): ?>
                                                        <input class="form-check-input active_inactive_btn "
                                                            ...
                                                            table="areas" type="checkbox" id="row_<?php echo e($val->id); ?>"
                            ...
                            <?php if(request()->get('status') == 'archived'): ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('area.restore')): ?>
                                    ...
                                    <form id="restore-form-<?php echo e($val->id); ?>"
                                        action="<?php echo e(route('areas.restore', Crypt::encryptString($val->id))); ?>" method="POST"
                                        style="display: none">
                                        <?php echo method_field('POST'); ?>
                                        <?php echo csrf_field(); ?>
                                    </form>
                            ...
                            <?php else: ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('area.delete')): ?>
                                    ...
                                    <form id="delete-form-<?php echo e($val->id); ?>" style="display: none"
                                        action="<?php echo e(route('areas.destroy', Crypt::encryptString($val->id))); ?>" method="POST">
                                        <?php echo method_field('DELETE'); ?>
                                        <?php echo csrf_field(); ?>
                                    </form>
                                <?php endif; ?>
